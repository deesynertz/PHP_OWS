...
<?php  
    ...
    if ($_SESSION['loged_in'] != TRUE || $_SESSION['loged_in_role'] != 1) {
...
?>
	...
	<div class="content">
        <h2 class="head-h text-white"><?php echo $_SESSION['loged_in_surname'];?> as Admin Functions <?php echo $_SESSION['loged_in_role'];?></h2> 
